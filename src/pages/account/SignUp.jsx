  ...
  return (
    <main className='flex justify-center'>
        <section className='container mx-auto mt-6'>
          ...
          <SignupForm/>
          <p className='text-gray-600 my-4 whitespace-nowrap'>Already have an account <Link className='font-semibold md:text-lg text-red-500 py-1 px-3 rounded-md '>Login</Link></p>
          </div>
